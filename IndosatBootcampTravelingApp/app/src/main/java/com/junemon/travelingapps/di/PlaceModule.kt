...
private val loadFeature by lazy {
    loadKoinModules(listOf(dataSourceModule, repositoryModules, useCaseModule, commonHelperModule,
        baseRecyclerViewModule, presentationModule, viewmodelModule, databaseModule))
}
